...
(function () {
  ...
  const SACRED_PLACES = {
    ...
    orthodox: { type: "mp", id: "yMmnj2d3Y7P", name: "the St. Elias Orthodox Cathedral", where: "",
      blurb: "Icons and painted saints cover every wall and dome. In Orthodox tradition the whole church is a window to heaven - stand in the aisle and let your eyes travel the frescoes." },
